...
public class TicketDetailPopover extends Popover {
	...
	private static final long serialVersionUID = -3254289403994897819L;
    ...
    public TicketDetailPopover(final Ticket ticket) {
        ...
        wrapper.addLayoutClickListener(new LayoutClickListener() {
			private static final long serialVersionUID = -5999233985579771910L;
    ...
    private Component buildTicketLayout(final Ticket ticket) {
        ...
        layout.addLayoutClickListener(new LayoutClickListener() {
			private static final long serialVersionUID = -4104802409692125556L;
    ...
    private void openImagePopup(final Ticket ticket) {
        ...
        image.addClickListener(new ClickListener() {
			private static final long serialVersionUID = 1997285351396306653L;
