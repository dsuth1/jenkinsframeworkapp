...
public class MapView extends CssLayout implements PositionCallback,
	...
	private static final long serialVersionUID = 7572073646305455327L;
	private LMap map;
    ...
    {
    	buildView();
    	ticketContainer = ParkingUI.getTicketContainer();
    	ticketContainer.addItemSetChangeListener(new ItemSetChangeListener() {
			private static final long serialVersionUID = -8645790857631193439L;
    ...
    private void buildView() {
        ...
        // Default to Shadow-Soft HQ
        //you.setPoint(new Point(33.986658, -84.362613));
        //Middle of the US
        you.setPoint(new Point(38.4449847, -99.8657227));
        
        setCenter();

        locatebutton = new Button("", new ClickListener() {
			private static final long serialVersionUID = -6056666506191926214L;
