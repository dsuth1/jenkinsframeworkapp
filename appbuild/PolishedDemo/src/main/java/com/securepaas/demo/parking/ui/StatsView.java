...
public class StatsView extends NavigationView {
	...
	private static final long serialVersionUID = 7781272384362593467L;
    ...
    private final BeanItemContainer<Ticket> ticketContainer = ParkingUI.getTicketContainer();
    ...
    public StatsView() {
    	buildUi();
    	ticketContainer.addItemSetChangeListener(new ItemSetChangeListener() {
			private static final long serialVersionUID = 8133436197644918379L;
    ...
    public final void updateTicketsPerDayChart(final BeanItemContainer<Ticket> ticketContainer) {
    ...
    public final void updateTicketsPerAreaChart(final BeanItemContainer<Ticket> ticketContainer) {
