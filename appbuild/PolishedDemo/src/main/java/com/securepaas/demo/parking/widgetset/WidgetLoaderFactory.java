package com.securepaas.demo.parking.widgetset;
...
public class WidgetLoaderFactory extends TouchKitBundleLoaderFactory {
    ...
    private final Set<String> usedConnectors;

    public WidgetLoaderFactory() {
        usedConnectors = new HashSet<String>();
    ...
    protected LoadStyle getLoadStyle(JClassType connectorType) {
    	if (usedConnectors.contains(connectorType.getQualifiedBinaryName())) {
